...
export const states = [
    ...
    [
        { name: "Algiers", id: 11 },
        { name: "Oran", id: 12 },
        { name: "Constantine", id: 13 },
        { name: "Annaba", id: 14 },
        { name: "Blida", id: 15 },
    ],
    [
        { name: "Andorra la Vella", id: 16 },
        { name: "Escaldes-Engordany", id: 17 },
        { name: "Sant Julia de Loria", id: 18 },
        { name: "Encamp", id: 19 },
        { name: "La Massana", id: 20 },
    ],
    [
        { name: "Luanda", id: 21 },
        { name: "Huambo", id: 22 },
    ...
    [
        { name: "St. John's", id: 26 },
        { name: "All Saints", id: 27 },
        { name: "Liberta", id: 28 },
        { name: "Potters Village", id: 29 },
        { name: "Seaview Farm", id: 30 },
    ],
    [
        { name: "Buenos Aires", id: 31 },
        { name: "Cordoba", id: 32 },
        { name: "Rosario", id: 33 },
        { name: "Mendoza", id: 34 },
        { name: "La Plata", id: 35 },
    ...
    [
        ...
        { name: "Gyumri", id: 37 },
        { name: "Vanadzor", id: 38 },
        { name: "Ejmiatsin", id: 39 },
        { name: "Hrazdan", id: 40 },
    ],
    [
        { name: "Sydney", id: 41 },
        { name: "Melbourne", id: 42 },
        { name: "Brisbane", id: 43 },
        { name: "Perth", id: 44 },
        { name: "Adelaide", id: 45 },
    ],
    ...
    [
        ...
        { name: "Ganja", id: 50 },
        { name: "Sumgait", id: 51 },
        { name: "Mingachevir", id: 52 },
        { name: "Nakhchivan", id: 53 },
    ],
    [
        { name: "Nassau", id: 54 },
        { name: "Freeport", id: 55 },
        { name: "West End", id: 56 },
        { name: "Coopers Town", id: 57 },
        { name: "Marsh Harbour", id: 58 },
    ],
    [
        { name: "Manama", id: 59 },
        { name: "Al Muharraq", id: 60 },
        { name: "Isa Town", id: 61 },
        { name: "Riffa", id: 62 },
        { name: "Sitra", id: 63 },
    ],
    [
        { name: "Dhaka", id: 64 },
        { name: "Chittagong", id: 65 },
        { name: "Khulna", id: 66 },
        { name: "Rajshahi", id: 67 },
        { name: "Sylhet", id: 68 },
    ],
    [
        { name: "Bridgetown", id: 69 },
        { name: "Speightstown", id: 70 },
        { name: "Oistins", id: 71 },
        { name: "Bathsheba", id: 72 },
        { name: "Holetown", id: 73 },
    ],
];
...
export const zipCodes = [[{ name: "2371", id: 1 }]];

export const unions = [[{ name: "Abdullahpur", id: 1 }]];
